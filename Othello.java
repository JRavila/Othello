...
public class Othello {
    ...
    /**
     * Starts the game and initializes it with: the first player, a chosen turn and the board.
     * 
     * @throws IOException
     */
    public void startGame() throws IOException /* the game starts*/{
        ...
        while(!board.gameOver()) { // when not GameOver, find the possible moves from the player
            ...
            this.players[ turn.getTurn() ].findCanSelect(); // find the possible moves at the location
	...
	private int readRow() {
        ...
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in)); // prompts for input of row
        Integer value = -1;
        try {
